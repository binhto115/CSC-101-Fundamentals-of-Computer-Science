...
def filterByState(p1: List[CountyDemographics], p2: str) -> List[CountyDemographics]:
    ...
    for i in p1:
        ...
        if state_name == p2:
            ...
            return []
    print(filtered_population_list)
...
def populationBelowPovertyLevel(p: List[CountyDemographics]) -> float:
    ...
    print(filtered_list_of_poverty_population)
...
def percentByEducation(p1: List[CountyDemographics], p2: str) -> float:
    ...
    round_population = round(population_as_percentage, 2)
...
def percentByEthnicity(p1: List[CountyDemographics], p2: str) -> float:
    ...
    for i in p1:
        ...
        if "2014 Population" in year_2014_population and p2 in ethnicity:
            ...
            return 0
    print(total_2014_ethnicity_list)
    print(total_2014_population_list)
    ...
    round_percentage = round(ethnicity_as_percentage, 2)
...
# prints out all the data of county demographics
...
if __name__ == "__main__":
    """ printAll(build_data.getData())
    print(len(build_data.getData()))"""

print(len(educationGreaterThan(build_data.getData(), "High School or Higher", 60)))
